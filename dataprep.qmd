...
* We can use recode from tidyverse if data is in a dataset. 
* The recode() function from the dplyr package in R is used to replace specific values in a vector or variable with new values. It allows you to map old values to new ones in a simple and readable manner.
