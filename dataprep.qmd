...
Note that we load data a little differently when it is preloaded from the browser. Use library(ISLR); data(Auto); on your own computer assuming the package is installed and then you can summarize like we do below. 
