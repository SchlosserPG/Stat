...
Each section includes a hands-on lab. The data preparation labs use dataprep.csv (79 house sales with Price, Sqft, Beds, Baths, OverallQual, and BuildDay). The visualization lab uses dataviz.csv (1,311 coffee quality reviews with Country.of.Origin, TotalScore, Flavor, Processing.Method, and others).

In the next part of the bootcamp, we shift from R to mathematics — the notation and concepts that underpin the statistical and machine learning models you will use throughout the MSBA program.
