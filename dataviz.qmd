...
-   For example, we can look at both the vs and gear variables in the ggplot command.
    ...
    -   Since there are two variables, you can set the position to _dodge_ to view the fill categorical variable side by side.
