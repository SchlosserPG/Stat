...
##note, we load data a little differently when it is preloaded from the browser. Use library(ISLR); data(College);  data(Credit) on your own computer assuming the package is installed. 
