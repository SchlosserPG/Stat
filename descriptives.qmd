...
::: callout-note
**Visualizations in Your Browser** You will build histograms, density plots, and boxplots using the Credit dataset directly in the browser. Work through each section in order, then complete the scored quiz.
:::
