...
**ChickWeight — build ANOVA and run Tukey HSD:**
...
**PlantGrowth — ANOVA and Tukey HSD:**
...
**Prepare data and build two-way ANOVA:**
...
**lstat → medv: scatter, correlation, and significance test:**
...
ggplot(Boston, aes(x = lstat, y = medv)) +
  ...
  labs(title = "Low Economic Status vs. Median House Value",
       x = "% Low Economic Status (lstat)", y = "Median House Value ($000s)")
```

**age → medv: a weaker correlation for comparison:**
...
ggplot(Boston, aes(x = age, y = medv)) +
  ...
  labs(title = "Age of Housing Stock vs. Median House Value",
       x = "Proportion Built Before 1940 (age)", y = "Median House Value ($000s)")
```
