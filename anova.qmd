...
* You can also calculate the factorial of a number using the factorial function in base R. This is the long way, but I put the formula below so that you could see what the choose function is doing. 
...
choose(4,2) #6 pairwise tests comparing comparing each group of races. 
```
...
```{r}
choose(3,2) #3 pairwise tests comparing each pair of instructors 
```
