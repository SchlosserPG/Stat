...
This lesson sits at the intersection of two skills that every business analyst needs: knowing how to use generative AI responsibly, and knowing how to communicate data honestly through visualization. The AI concepts introduced in earlier chapters — what generative AI is, how it differs from predictive AI, the four analytics categories, hallucination warning signs, and prompt specificity — have been building toward this lesson. Here, those threads come together and are applied to their most important practical output: data visualizations.

We begin with a **compact review of generative AI** — sharpening the concepts you have encountered throughout the course with a focus on how LLMs work at a mechanical level, the full prompt engineering toolkit, and verification practices. The goal is consolidation, not repetition: you will apply these skills immediately in the lab.
...
-   This lesson synthesizes two threads that have run through the entire course: using AI as a tool, and communicating data honestly. The AI concepts you have encountered in every prior chapter — hallucinations, prompt specificity, the handles/requires-judgment division — come together here and are applied to visualization, the output type you have been producing all semester. Pay close attention to how the Trifecta Checkup formalizes the analytical judgment you have been exercising informally since the first lesson.

### Lesson Objectives

-   Consolidate understanding of generative AI: LLM mechanics, hallucination warning signs applied to chart output, and the three prompting strategies.
...
-   As you read the AI section, treat it as consolidation, not new material. The goal is to sharpen and connect concepts you have been using all semester — especially the question of what you are responsible for that AI is not.
...
## A Quick Recap: The AI Landscape

You were introduced to the AI landscape in the first lesson of this course. Here is the framework as a quick reference before we go deeper on mechanics and prompting.

**Artificial Intelligence → Machine Learning → Deep Learning → Generative AI.** Generative AI sits within deep learning, and deep learning within ML, and ML within AI. Generative AI is the layer that *creates* — text, code, images, audio — rather than classifying or predicting.

![Generative AI within the AI Landscape](images/GenAI.png){width=90%}

**Generative vs. predictive AI — the most important distinction for this course:**
...
When you run a regression, you are building a **predictive** model. When you use Claude or ChatGPT to write R code, you are using a **generative** model.

**Narrow vs. General vs. Strong AI — why it matters:**

![Narrow AI, General AI, and Strong AI — Where Generative AI Sits](images/GenAI_paradigm.png)

Even the most capable generative AI tools are **Narrow AI** — extraordinary within the domain of language but unable to generalize outside it the way a human expert can. A large language model pattern-matches against its training data. It does not reason from first principles. This is why it can write confident-sounding code that is subtly wrong, and why your verification skills matter.

**The four analytics categories — where this course fits:**

-   **Descriptive analytics** — what happened (the first half of this course)
-   **Diagnostic analytics** — why it happened (correlation, ANOVA)
-   **Predictive analytics** — what will happen (regression — the final modeling lesson)
-   **Prescriptive analytics** — what we should do (beyond this course's scope)

AI accelerates all four categories. Your job throughout the course has been to supply the question, the data context, and the judgment that AI cannot.
...
## LLM Hallucinations: A Recap

Hallucinations were introduced in the first lesson of this course. Here is the key framework as a reference before the visualization lab — because hallucinations appear in AI-generated charts just as they appear in AI-generated text.

**Hallucinations** occur when an LLM generates plausible-sounding but factually incorrect content. The model does not know it is wrong — it produces the statistically most likely continuation of the prompt. This is a structural property, not a fixable bug.

**Five warning signs — applied to visualization output:**
