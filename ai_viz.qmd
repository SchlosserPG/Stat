...
This lesson sits at the intersection of two skills that every business analyst needs: knowing how to use generative AI responsibly, and knowing how to communicate data honestly through visualization. The AI concepts introduced in earlier chapters — what generative AI is, how it differs from predictive AI, the four analytics categories, hallucination warning signs, and the three prompting strategies — have been building toward this lesson. Here, those threads come together and are applied to their most important practical output: data visualizations.

We begin with **generative AI applied to visualization** — going deeper on how LLMs work at a mechanical level and applying the hallucination warning signs and prompt engineering toolkit specifically to chart output. These are the same skills you have been practicing all semester, now focused on their most visible deliverable.
...
-   This lesson synthesizes two threads that have run through the entire course: using AI as a tool, and communicating data honestly. The AI concepts you have practiced all semester — hallucinations, prompt strategies, the handles/requires-judgment division — are applied here to visualization, the output type you have been producing all semester. Pay close attention to how the Trifecta Checkup formalizes the analytical judgment you have been exercising informally since the first lesson.
...
-   In the AI section, focus on how the concepts you have been using all semester — hallucinations, prompt specificity, the handles/requires-judgment division — apply in new ways when the output is a chart rather than code or text.
...
You have been working with the hallucination warning signs since the first lesson of this course. Here they are applied specifically to chart output, where they take distinct and consequential forms:
