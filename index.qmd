...
-   Open an internet browser and go to [https://www.r-project.org/](https://www.r-project.org/).
-   Click CRAN hyperlink underneath Download on the left.
-   Select a CRAN location (a mirror site) and click the corresponding link. I selected O-cloud. This brings you to the following link: [https://cloud.r-project.org/](https://cloud.r-project.org/)
...
-   Go to the following URL: [https://posit.co/download/rstudio-desktop/](https://posit.co/download/rstudio-desktop/).
