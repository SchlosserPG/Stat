...
This site uses Google Analytics 4 only to measure aggregate page views and session engagement. Advertising features, remarketing, and demographic reporting are not used. User consent is handled through Google Consent Mode before analytics cookies are enabled.
:::
