...
* We want all scores to be under 10 to indicate the absence of multicollinerity. 
...
-   Use the following prompt on a generative AI, like chatGPT to learn more about regression analysis in R.
    -   Perform a simple linear regression analysis in R and interpret the results. Use the lm() and summary() functions for regression analysis. Discuss the interpretation of the intercept and slope, and the meaning of R-squared.
