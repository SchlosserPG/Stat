...
![Venn Diagram](Pictures/Ch5/Venn1.png "Venn Diagram")
...
*  If a person is under 35, what is the probability they will select Under Armour? 
$$P(UA|under35) = (P(UA \cap under35)/P(under35))$$
...
prob[1,1]/rowprob[1]
```
* What is the probability of a person 35 or older randomly selecting Nike?
$$P(N|older35) = (P(N \cap older35)/P(older35))$$
