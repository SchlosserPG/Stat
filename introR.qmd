...
::: callout-note
This lesson walks through the swirl exercises on creating and loading data in R. Copy each code block into your RStudio console or script file and run it as you work through the lesson.
:::
