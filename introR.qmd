...
::: callout-note
This lesson walks through the swirl exercises on creating and loading data in R. 
...
**Load and explore the Auto dataset from the ISLR dataset:**

```{webr-r}
##instead of saying data(Auto), we use the following because the dataset is preloaded on this account. 
Auto <- ISLR::Auto
summary(Auto)
```
