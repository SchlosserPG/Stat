...
Note that several important topics — regression assumptions, transformations, effect size, and partial correlations — were intentionally reserved for future courses in the OMSBA program. The goal here was to build a solid, working foundation across the full arc of a statistics course. The rest follows from this.
