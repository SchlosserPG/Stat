...
::: {.callout-note}
This lesson combines the two probability swirl exercises. Part 1 covers binomial and normal probability functions. Part 2 covers contingency tables, probability rules, and the chi-squared test. All calculations run entirely in the browser — no packages or data files needed.
