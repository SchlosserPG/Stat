...
::: {.callout-note}
This lesson combines the two probability swirl exercises. Part 1 covers binomial and normal probability functions. Part 2 covers contingency tables, probability rules, and the chi-squared test. All calculations use base R — no additional packages needed.

Copy each code block into your RStudio console and run it as you work through the lesson.
:::

```{r, eval=FALSE}
# No packages or data needed — all base R
```
